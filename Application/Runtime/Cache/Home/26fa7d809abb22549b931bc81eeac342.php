...
<script type="text/javascript">
	...
	$(function(){
		if(getCookie('page') != "manage-borrow"){
		...
		<?php if($isPersonnel): ?>$(".btn-approbate").click(function(e){
				var index = $(e.target).parent().parent().index();
				approbateBorrow(borrowList[index]);
			});<?php endif; ?>	
	});
	...
	function onSearch(){
		...
		window.location.href = "<?php echo U('Manage/borrow');?>"+"&"+$("#query-form").serialize();
	}
</script>