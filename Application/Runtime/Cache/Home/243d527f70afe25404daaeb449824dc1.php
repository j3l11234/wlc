				...
				<div class="row">	
					...
					<div class="col-lg-4 col-sm-6 form-div">
						<div style="input-group; text-align: center;">
							<button style="width:45%" type="button" onclick="addOrder()" class="btn btn-success">新申请</button>
							&nbsp;
...
<script type="text/javascript">
	...
	function onSearch(){
		...
		window.location.href = "<?php echo U('Main/order');?>"+"&"+$("#query-form").serialize();
	}
</script>