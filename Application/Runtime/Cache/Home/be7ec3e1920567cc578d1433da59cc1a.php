...
<div class="row">
  ...
  <div class="panel-body">
    <div class="list-group">
      <a href="<?php echo U('Manage/attend');?>" class="list-group-item <?php echo getIsActive('sidebar-attend',$sidebar_item);?>">签到记录</a>

      <a href="<?php echo U('Manage/workplan');?>" class="list-group-item <?php echo getIsActive('sidebar-workplan',$sidebar_item);?>">工作计划</a>

      <a href="<?php echo U('Manage/errand');?>" class="list-group-item <?php echo getIsActive('sidebar-errand',$sidebar_item);?>">出差列表
      <span class="badge"><?php echo getPendingNum('errand');?></span>
      </a>
      <a href="<?php echo U('Manage/leave');?>" class="list-group-item <?php echo getIsActive('sidebar-leave',$sidebar_item);?>">请假审批
        <span class="badge"><?php echo getPendingNum('leave');?></span>
      </a>
      <a href="<?php echo U('Manage/order');?>" class="list-group-item <?php echo getIsActive('sidebar-order',$sidebar_item);?>">订餐审批
        <span class="badge"><?php echo getPendingNum('order');?></span>
      </a> 
      <a href="<?php echo U('Manage/borrow');?>" class="list-group-item <?php echo getIsActive('sidebar-borrow',$sidebar_item);?>">借用审批
         <span class="badge"><?php echo getPendingNum('borrow');?></span>
      </a>
    </div>         
  </div>
</div> 
